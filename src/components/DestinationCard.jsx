  ...
  return (
    ...
    >
        ...
        {!imageError ? (
          ...
          <div className="w-full h-full flex items-center justify-center bg-gray-100">
            <div className="text-center p-4">
              ...
              <p className="text-gray-500 text-sm">{t.imageNotAvailable}</p>
            </div>
          </div>
        )}
      ...
      <div className="p-4 sm:p-6">
        <h3 className="text-xl sm:text-2xl font-semibold text-gray-900 mb-1 sm:mb-2">{destination.name || t.unnamedPlace}</h3>
        <p className="text-gray-600 mb-2 sm:mb-4 line-clamp-1 text-sm sm:text-base">{destination.description || t.noDescription || 'No description available'}</p>
