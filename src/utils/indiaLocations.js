// This file contains the states and districts of India for location filtering
...
const indiaLocations = {
  "Andhra Pradesh": [
    ...
    "Nandyal", "NTR", "Palnadu", "Prakasam", "Srikakulam", "Sri Sathya Sai", 
  ...
  "Gujarat": [
    ...
    "Botad", "Chhota Udepur", "Dahod", "Dang", "Devbhoomi Dwarka", "Gir Somnath", 
  ...
  "Lakshadweep": [
    "Agatti", "Amini", "Andrott", "Bangaram", "Bitra", "Chetlat", "Kadmat", "Kalpeni", 
...
// Get all states
const getAllStates = () => {
  return Object.keys(indiaLocations);
};
...
// Get Hindi translation for a state
const getStateTranslation = (state) => {
  return stateTranslations[state] || state;
};

export { getAllStates, getDistrictsForState, getStateTranslation }; 