...
const Explore = ({ language, setLanguage, languages, user }) => {
  ...
  }, [destinations, sortOrder, sortBy, ratingFilter, showTrending]);
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-16 sm:pt-20 pb-8 sm:pb-12 px-3 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        {loading ? (
          ...
          <>
            <motion.div 
              className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl shadow-sm p-4 sm:p-8 mb-6 sm:mb-8"
            ...
            >
              <div className="flex flex-col sm:flex-row sm:flex-wrap gap-4 sm:gap-6 sm:items-center sm:justify-between">
                <div className="flex flex-col sm:flex-row gap-3 sm:gap-6 w-full sm:w-auto">
                  <motion.div className="sort-dropdown relative w-full sm:w-auto" variants={filterItemVariants}>
                    <button
                      onClick={() => setIsDropdownOpen(!isDropdownOpen)}
                      className="w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 rounded-md bg-white shadow-sm hover:shadow-md transition-all duration-300 flex items-center space-x-2 border border-gray-100 cursor-pointer justify-between sm:justify-start"
                    >
                    ...
                    {isDropdownOpen && (
                      <div className="absolute mt-2 w-full sm:w-64 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50">
                        {[
                  ...
                  <motion.div className="rating-dropdown relative w-full sm:w-auto" variants={filterItemVariants}>
                    <button
                ...
                <motion.div className="relative w-full sm:w-auto">
                  <motion.button
                    ...
                    className={`w-full sm:w-auto px-4 sm:px-6 py-2 sm:py-3 rounded-md transition-all duration-300 flex items-center justify-center sm:justify-start space-x-2 cursor-pointer ${
                      showTrending
                  ...
                  {showTrendingTooltip && (
                    <div className="absolute mt-2 w-64 bg-white rounded-lg shadow-lg border border-gray-100 py-2 px-3 z-50 text-sm right-0 sm:left-auto">
                      {language === 'hi' 
